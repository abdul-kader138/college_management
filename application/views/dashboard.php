    ...
    <div class="tile_count">
        <?php if (has_permission(VIEW, 'student', 'student')) { ?>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                <div class="stats-count-inner" style="background-color: #82589F;color: white">
                    <span class="count_top"><i class="fa fa-group"
                                               style="color: white"></i> <?php echo $this->lang->line('total'); ?> <?php echo $this->lang->line('student'); ?></span>
                    <div class="count" style="color: white"><?php echo $total_student ? $total_student : 0; ?></div>
                </div>
            </div>
        <?php } ?>
        <?php if (has_permission(VIEW, 'guardian', 'guardian')) { ?>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                <div class="stats-count-inner" style="background-color: #e17055;color: white">
                    <span class="count_top"><i class="fa fa-paw"
                                               style="color: white"></i> <?php echo $this->lang->line('total'); ?> <?php echo $this->lang->line('guardian'); ?></span>
                    <div class="count" style="color: white"><?php echo $total_guardian ? $total_guardian : 0; ?></div>
                </div>
            </div>
        <?php } ?>
        <?php if (has_permission(VIEW, 'teacher', 'teacher')){ ?>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <div class="stats-count-inner" style="background-color: #00c0ef;color: white"
            ">
            <span class="count_top"><i class="fa fa-users"
                                       style="color: white"></i> <?php echo $this->lang->line('total'); ?> <?php echo $this->lang->line('teacher'); ?></span>
            <div class="count" style="color: white"><?php echo $total_teacher ? $total_teacher : 0; ?></div>
        </div>
    </div>
    <?php } ?>
    <?php if (has_permission(VIEW, 'hrm', 'employee')) { ?>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <div class="stats-count-inner" style="background-color: #FC427B;color: white">
                <span class="count_top"><i class="fa fa-user-md"
                                           style="color: white"></i> <?php echo $this->lang->line('total'); ?> <?php echo $this->lang->line('employee'); ?></span>
                <div class="count" tyle="color: white"><?php echo $total_employee ? $total_employee : 0; ?></div>
            </div>
        </div>
    <?php } ?>
    <?php if (has_permission(VIEW, 'accounting', 'income')) { ?>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <div class="stats-count-inner" style="background-color: #f1c40f;color: white">
                <span class="count_top" style="color: white">
                ...
                <div class="count green"
                     style="color: white"><?php echo $total_income ? $total_income : '0.00'; ?></div>
            </div>
        </div>
    <?php } ?>
    <?php if (has_permission(VIEW, 'accounting', 'expenditure')) { ?>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <div class="stats-count-inner" style="background-color: #1abc9c;color: white">
            <span class="count_top" style="color: white">
                <?php echo isset($school_setting->currency_symbol) ? $school_setting->currency_symbol : '$'; ?>
                <?php echo $this->lang->line('total'); ?><?php echo $this->lang->line('expenditure'); ?>
            </span>
                <div class="count red"
                     style="color: white"><?php echo $total_expenditure ? $total_expenditure : '0.00'; ?></div>
            </div>
        </div>
    <?php } ?>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel tile overflow_hidden">
                <div class="x_title">
                    <h4 class="head-title"><?php echo $this->lang->line('statistics'); ?></h4>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel tile overflow_hidden">
                ...
                <div class="x_content">
                    <div id="calendar"></div>
                    <link rel='stylesheet'
                          href='<?php echo VENDOR_URL; ?>fullcalendar/lib/cupertino/jquery-ui.min.css'/>
                    <link rel='stylesheet' href='<?php echo VENDOR_URL; ?>fullcalendar/fullcalendar.css'/>
                    <script type="text/javascript"
                            src='<?php echo VENDOR_URL; ?>fullcalendar/lib/jquery-ui.min.js'></script>
                    <script type="text/javascript"
                            src='<?php echo VENDOR_URL; ?>fullcalendar/lib/moment.min.js'></script>
                    <script type="text/javascript"
                            src='<?php echo VENDOR_URL; ?>fullcalendar/fullcalendar.min.js'></script>
                    <script type="text/javascript">
                        $(function () {
